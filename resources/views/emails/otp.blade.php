        ...
        <div class="email-container">
            ...
            <div class="email-body">
                ...
                <div style="text-align: center; margin: 30px 0;">
                    <a href="{{ config('app.frontend_url') }}/login.html?email={{ urlencode($email) }}&purpose={{ urlencode($purpose) }}" 
                       style="display: inline-block; background-color: #084466; color: #ffffff; text-decoration: none; padding: 15px 40px; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(8, 68, 102, 0.3); transition: background-color 0.3s ease;">
                        Verify OTP
                    </a>
                    <p style="color: #666666; font-size: 14px; margin-top: 15px;">
                        If you closed the verification page, click the button above to access it again.
                    </p>
                </div>
                @endif
